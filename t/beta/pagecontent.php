...
<div class="container">
	...
	<div class="right-column">
		<ul id="tab" class="nav nav-tabs">
			<li class="active"><button class="tabbtn" href="#tab-democratus"  data-toggle="tab" rel="about" >Democratus</button></li>
            <li><button class="tabbtn" href="#tab-gizlilik"  data-toggle="tab" rel="privacy" >Gizlilik Bilgisi</button></li>
			<li><button class="tabbtn" href="#tab-hizmet"  data-toggle="tab" rel="service-terms" >Hizmet Bilgisi</button></li>
			<li><button class="tabbtn last" href="javascript:;" onclick="target='_blank'; location.href='http://democratus.com/blog';"   >Blog</button></li>
           
          </ul>
        <div id="myTabContent" class="tab-content roundedcontent">
        	
            <div class="tab-pane fade in active" id="tab-democratus">
            	{{main}}
			</div>
            <div class="tab-pane fade" id="tab-gizlilik">
              	{{privacyPage}}
            </div>
            <div class="tab-pane fade" id="tab-hizmet">
            	{{servicetermsPage}}
            </div>
          </div>
	</div> 
    ...
    ?>
    <!-- <script src="<?=$this->url?>docs/assets/js/jquery.js"></script>  -->
