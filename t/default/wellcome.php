...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en">
    ...
    $model->addScript($this->url . 'static/javascript/selectbox.js', 'static/javascript/selectbox.js', 1 );
	...
	<body>
		...
		<div id="container">
			...
			<div id="header">
                ...
                <!-- Logo & Search [Begin] -->
                <div class="logo">
                    <a href="/"><img src="<?=$this->url;?>static/image/background/header/logo.png" alt="Democratus Logosu" /></a>
                </div>
<?php
